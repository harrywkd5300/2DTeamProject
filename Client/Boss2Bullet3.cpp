...
CBoss2Bullet3::CBoss2Bullet3(void)
{
}
...
void CBoss2Bullet3::Render(HDC hdc)
{
	Rectangle(hdc, m_tRect.left, m_tRect.top,
		m_tRect.right, m_tRect.bottom );

	HDC hMemDC = (CBmpMgr::GetInstance()->FindBmp(L"Boss2FireBullet"))->GetMemDC();

	TransparentBlt(hdc,int(m_tInfo.vPos.x - 15) , int(m_tInfo.vPos.y - 15), 30, 30
		, hMemDC, m_tFrame.iFrameStart * 18, 0
		, 18, 18, RGB(255, 0, 255));
}

void CBoss2Bullet3::Release()
{
