...
void CMonster04::initirize()
{
	...
	//m_tInfo.vPos = D3DXVECTOR3( 400.f, 200.f, 0.f );
...
void CMonster04::Render(HDC hdc)
{
	...
	HDC hMemDC = (CBmpMgr::GetInstance()->FindBmp(L"Monster4"))->GetMemDC();
	HDC hMemDC2 = (CBmpMgr::GetInstance()->FindBmp(L"MonsterR4"))->GetMemDC();
