...
void CMonster01::Render(HDC hdc)
{
	...
	HDC hMemDC = (CBmpMgr::GetInstance()->FindBmp(L"Monster1"))->GetMemDC();
	HDC hMemDC2 = (CBmpMgr::GetInstance()->FindBmp(L"MonsterR1"))->GetMemDC();
